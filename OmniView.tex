...
In the first section at the left side there is an input field labeled "saving path" (Speicherpfad) accompanied by a "Browse" (Durchsuchen) button that is at the right side of the input field. Over the input field there should be the text "choose your saving path" (Wähle deinen Speicherpfad).  The buttons should be designed after the design principle in chapter \ref{cap:Designprinciples_PopupWindowButtons}\\
